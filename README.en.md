...
- Generate and package fixed-stage HTML slide decks.
- Keep finished output portable: root `index.html` plus relative local assets.
- Bundle a practical post-generation editor into generated decks.
- Keep the editor runtime deck-neutral inside the supported Frontend Slides contract.
- Preserve clear attribution to the original project.
...
- It does not claim support outside the fixed-stage deck contract: `#deckStage` or `.deck-stage`, `.slide`, and 1920x1080 stage coordinates.
